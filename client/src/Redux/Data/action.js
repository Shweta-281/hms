...
export const CreateReport = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://server-mu-five-58.vercel.app/reports/create",
      data
    );
    console.log(res);
    dispatch({
...
export const GetDoctorDetails = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      "https://server-mu-five-58.vercel.app/doctors"
    );
    console.log(res);
    // dispatch({
...
export const AddPatients = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://server-mu-five-58.vercel.app/patients/register",
      data
    );
    return res.data;
    // dispatch({
...
export const CreateBeds = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://server-mu-five-58.vercel.app/beds/add",
      data
    );
    return res.data;
    // dispatch({
...
export const GetBeds = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get("https://server-mu-five-58.vercel.app/beds");
    console.log(res);
    dispatch({
...
export const CreateBooking = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      `https://server-mu-five-58.vercel.app/appointments/create`,
      data
    );
    console.log(res);
    dispatch({ 
...
export const GetSingleBed = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://server-mu-five-58.vercel.app/beds/single",
      data
    );
    // console.log(res);
    return res.data;
...
export const EditSingleBed = (data, id) => async (dispatch) => {
  try {
    ...
    const res = await axios.patch(
      `https://server-mu-five-58.vercel.app/beds/${id}`,
      data
    );
    // console.log(res);
    return res.data;
...
export const dischargePatient = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.put(
      `https://server-mu-five-58.vercel.app/beds/discharge`,
      data
    );
    console.log(res);
    // return res.data;
...
export const GetPatients = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `https://server-mu-five-58.vercel.app/patients`
    );
...
export const GetAllData = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `https://server-mu-five-58.vercel.app/hospitals`
    );
    console.log(res.data);
    dispatch({
...
export const GetAllAppointment = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `https://server-mu-five-58.vercel.app/appointments`
    );
    console.log(res.data);
    // return res.data;
    dispatch({
...
export const DeleteAppointment = (id) => async (dispatch) => {
  try {
    ...
    const res = await axios.delete(
      `https://server-mu-five-58.vercel.app/appointments/${id}`
    );
    console.log(res.data);
    // return res.data;
    dispatch({
...
export const GetAllReports = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `https://server-mu-five-58.vercel.app/reports`
    );
    console.log(res.data);
